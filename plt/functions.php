...
function upload_pp($nik) {
	...
	$namaFileBaru .='.';
	$namaFileBaru .= $ekstensiGambar;
	$direct = "assets/img/profil/".$namaFileBaru;
	...
	$namaFileBaru .='.';
	$namaFileBaru .= $ekstensiGambar;
	$directbg = "../plt/iPortfolio/assets/img/backgrounds/".$namaFileBaru;
	$directpp = "../plt/iPortfolio/assets/img/profiles/".$namaFileBaru;
	
	//$lokasi = $tmpName.$ekstensiGambar;

	$query = "UPDATE wisata SET
			 background='$namaFileBaru'
			WHERE nama ='$nama' AND koordinat ='$maps'
			 ";
	mysqli_query ($conn, $query);

	move_uploaded_file($tmpName, $directbg);
	
	return mysqli_affected_rows($conn);
	}
}function upload_galeri($id) {
	global $conn;
	$namaFile=$_FILES['gambar'] ['name'];
	$ukuranFile=$_FILES ['gambar'] ['size'];
	$error=$_FILES ['gambar'] ['error'];
	...
	$namaFileBaru .='.';
	$namaFileBaru .= $ekstensiGambar;
	$directbg = "assets/img/portfolio/".$namaFileBaru;
...
function sunting_bg($nama, $maps) {
	...
	$namaFileBaru .='.';
	$namaFileBaru .= $ekstensiGambar;
	$directbg = "assets/img/backgrounds/".$namaFileBaru;
