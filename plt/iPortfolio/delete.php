...
<div class="jumbotron jumbotron-fluid">
        <div class="container">
          <?php 
            if(isset($_GET['pesan'])){
              if($_GET['pesan']=="gagal"){
                ...
                echo "<h4 class='display-4'>Anda yakin ingin menghapus data ini?</h4>";
              }
            }else{
                echo "<h4 class='display-4'>Anda yakin ingin menghapus data ini?</h4>";
            }
          ...
          <a href="wisata.php?id=<?=$_SESSION['id_wisata'];?>#portfolio" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style="background-color: #DC143C ; border-color: #DC143C; font-size: 11pt; " autocomplete="on">Kembali</a>
          </div></div></div>
